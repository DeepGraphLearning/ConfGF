...
python -u script/get_task1_results.py \
							--input checkpoint_dir_of_QM9 --core 10 --threshold 0.5  

python -u script/get_task1_results.py \
							--input checkpoint_dir_of_Drugs --core 10 --threshold 1.25  
```
...
COV and MAT scores on GEOM-Drugs
...
```bash
python -u script/get_task2_results.py --input checkpoint_dir_of_ISO17
```
